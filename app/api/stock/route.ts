...
export async function POST(request: Request) {
    try {
        ...
        return NextResponse.json({
            ...
            financialScoresSaved: !!result.financialScores,
            ratiosSaved: result.ratios.length > 0,
            ratiosTtmSaved: !!result.ratiosTtm,
            financialGrowthSaved: result.financialGrowth.length > 0,
            earningsSaved: result.earnings.length > 0,
